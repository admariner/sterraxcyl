...
class _analysis:
    def __init__(self,_:object, data:list, **kwargs) -> None:
        ...
        self.ignore_over = kwargs.get("ignore_over") or 10000
        self.pctg = kwargs.get("pctg") or 0
        self.size = kwargs.get("size") or len(self.data)
    ...
    def personnal(self) -> list:
        ...
        def fais_le_boulot(acc:dict) -> dict:
            ...
            if acc['biography'] and findall(repv, acc['biography']):
                probas += [100]*_PERSONNAL_PRIVATE_IN_DESC

            if acc["full_name"] and findall(repv, acc["full_name"]):
    ...
    def interests(self) -> list:
        ...
        def fais_le_boulot(acc:dict) -> dict:
            ...
            probas += [
                100 - min(acc['following'], 1500) * 100 / 1500
            ] * _INTERESTS_FOLLOWING_COUNT
